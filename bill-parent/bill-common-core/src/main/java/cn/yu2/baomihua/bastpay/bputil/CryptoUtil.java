 ...
 public static String getSHA256(String str,String algorithm){
        ...
        try {
            ...
            for(int i = 0; i < blocksNum; ++i) {
                ...
                try {
                    ...
                    throw new GeneralSecurityException("RSA鍔�/瑙ｅ瘑鏃跺嚭鐜板紓甯�", var19);
                }
            }
    ...
    public static X509Certificate base64StrToCert(String base64Cert) throws GeneralSecurityException {
        try {
            ...
            if(cert == null) {
                throw new GeneralSecurityException("灏哻er浠巄ase64杞崲涓哄璞″け璐�");
            } else {
                return cert;
            }
        } catch (IOException var3) {
            throw new GeneralSecurityException("灏哻er浠巄ase64杞崲涓哄璞″け璐�", var3);
        }
    }
