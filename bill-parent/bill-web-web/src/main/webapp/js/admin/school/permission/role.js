...
require(['jqtransform','headerSlideDown'], function(jqtransform,aaaa) {
	 ...
	 $(".clickLi").click(function(){
	 	window.location.href="/manage/school/permission/roleList.html?roleId="+$(this).attr("myId")
	 });
	...
	$('.roleGroup li').find('p').on('click',function(){
 	...
 	$(".cancel").click(function(){
 		...
 		window.location.href="/manage/school/permission/roleList.html?roleId="+roleId
 	})
