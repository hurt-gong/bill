...
require(['jqtransform','headerSlideDown'], function(jqtransform,aaaa) {
	 ...
	 $('.look_analysis').on('click',function(){
	 	//$('.look_analysis_box').show();
	 	$(this).parents('.analysis').find('.look_analysis_box').show();
	 });
	 $('.look_respond_con li').on('click',function(){
	 	$(this).addClass('word_change').siblings().removeClass('word_change');
	 });
	 //如果是被选中的时候添加类名
	 $('._names span label').on('click',function(){
