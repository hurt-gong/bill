...
@Controller
@RequestMapping("/manage/distric/dept/")
public class DeptController extends BaseController {
	...
	public String list( Model model, Long id ) {
		...
		return "manage/distric/dept/list";
	...
	public String del( long id ) {
		String url = "/manage/distric/dept/list.html";
		Role role = deptModule.getDept(id).getBody();
		Long pid = role.getPid();
		deptModule.deleteById(id);
		if ( pid != 0L ) {
			url = "/manage/distric/dept/list.html?id=" + pid;
		}
	...
	public String updateUsers( Model model, @RequestParam("deptId" ) Long deptId,
	...
	public String delroleteacher( Long id ) {
		deptModule.deleteRoleTeacherById(id);
