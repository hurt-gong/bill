...
@Controller
@RequestMapping("/manage/school/book/")
public class SchoolBookController extends BaseController {
	...
	public String list(Model model, @RequestParam(value = "phaseId", required = false) String phaseId,
		...
		return "manage/school/book/bookList";
	}
	...
	public String insertBook(Model model, String bookName, String yuan, String id, String ageId, String phId,
		...
		return redirectTo("/manage/school/book/list.html?phaseId=" + phId + "&subjectId=" + subId);
	}
	...
	public String editBook(Model model, Long id) {
		...
		return redirectTo("/manage/school/book/list.html");
	}
}
