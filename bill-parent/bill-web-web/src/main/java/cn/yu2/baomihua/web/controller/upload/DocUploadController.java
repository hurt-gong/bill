...
public class DocUploadController extends BaseController {
...
//		String dir = SSOConfig.getSSOProperties().get("upload.savedir");
...
//						msg = FastDfsHelper.uploadFastDfs(request, saveDir, cf, dfsClient, fileMd5Module);
						...
						logger.error("文档转换地址：{}",newFileStr);
		 ...
		 /** 1、如果只有一个文件返回 UploadMsg 对象
		 * 2、其他情况返回 UploadMsg 列表
		 */ 
		...
		factory.setSizeThreshold(500*1024*1024);
		//高水平的API文件上传处理
